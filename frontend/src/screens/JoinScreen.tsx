...
import joinStyle from '../styles/JoinStyles';
...
const JoinScreen = (): JSX.Element => {
  ...
  return (
    <View style={defaultStyle.container}>
      ...
      <CustomText style={{fontSize: 20, color: '#aaa'}}>어떻게 방문하셨나요?</CustomText>
      <View style={{height: 70}}></View>
      <View style={joinStyle.buttons}>
        <TouchableOpacity onPress={() => onPress('SOCIAL_WORKER')} style={joinStyle.button}>
        ...
        <TouchableOpacity onPress={() => onPress('FAMILY')} style={joinStyle.button}>
          <Icon style={[joinStyle.icon, {fontSize: 50}]} name="account-multiple"/>
          <View style={{height: 20}}></View>
